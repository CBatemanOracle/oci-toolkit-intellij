 ...
 * C.B 2024: copied from OCI SDK, copyright notice unchanged.  We will try to patch this change back into
 *           OCI (https://github.com/oracle/oci-java-sdk).  This change exposes the profile names and key/value 
 *           pairs that are already being parsed in. This is needed by tools (IntelliJ) and admin tools.
 */
