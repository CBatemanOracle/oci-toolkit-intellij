...
;
    ...
    @PropertyOrder(4)
    @VariableMetaData(defaultVal="https://github.com/oracle-quickstart/appstack/blob/main/usage_instructions.md#container-instance-configuration",type="link",required = true)
