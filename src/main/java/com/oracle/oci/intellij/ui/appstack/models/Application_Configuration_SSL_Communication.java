...
public class Application_Configuration_SSL_Communication extends VariableGroup {
    ...
    @PropertyOrder(10)
    @VariableMetaData(defaultVal="https://github.com/oracle-quickstart/appstack/blob/main/usage_instructions.md#ssl-configuration-between-load-balancer-and-backend",type="link")
